document.addEventListener("DOMContentLoaded", function () {
  ...
  <hr>
      ...
      <p>
        Designed by 
        <a href="lanka_enterprises">Ayush's Enterprise</a> &copy;2023
      </p>
      <p class="valid">
        <a href="https://validator.w3.org/check?uri=referer" target="_blank">
          <img style="border:0;width:88px;height:31px" src="http://www.w3.org/Icons/valid-html40.png" alt="Link To HTML Validatorr" />
        </a>
